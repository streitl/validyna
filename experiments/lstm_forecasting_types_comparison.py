...
from ecodyna.mutitask_models import MultiTaskLSTM
...
models_and_params = [
    (MultiTaskLSTM, {'n_hidden': 32, 'n_layers': 1, 'forecast_type': 'n_out', 'n_classes': 2, 'n_features': 32}),
    (MultiTaskLSTM, {'n_hidden': 32, 'n_layers': 1, 'forecast_type': 'recurrent', 'n_classes': 2, 'n_features': 32}),
]
