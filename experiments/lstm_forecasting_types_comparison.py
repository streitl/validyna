...
from ecodyna.mutitask_models import MultiTaskLSTM, MultiTaskTimeSeriesModel
...
if __name__ == '__main__':
    ...
    models_and_params: Sequence[Tuple[Type[MultiTaskTimeSeriesModel], Dict]] = [
        (MultiTaskLSTM, {'n_hidden': 32, 'n_layers': 1, 'forecast_type': 'n_out'}),
        (MultiTaskLSTM, {'n_hidden': 32, 'n_layers': 1, 'forecast_type': 'recurrent'})
    ]
