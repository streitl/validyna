...
def forecasting_into_classification(**params):
    ...
    for space_dim, attractors in attractors_per_dim:
        ...
        for Model, model_params in params['models']['list']:
            ...
            wandb_logger = get_logger(f'{run_id}_f', model.hyperparams, **params)
            ...
            wandb_logger = get_logger(f'{run_id}_f_c', model.hyperparams, **params)
...
if __name__ == '__main__':
    ...
    forecasting_into_classification(**params)
