...
from models.mutitask_models import MultiTaskTimeSeriesModel
...
def classification_into_forecasting(params: dict):
    ...
    for space_dim, attractors in attractors_per_dim:
        ...
        for Model, model_params in params['models']['list']:
            model: MultiTaskTimeSeriesModel = Model(space_dim=space_dim, n_classes=dataset.n_classes,
            ...
            trainer.fit(forecaster, train_dataloaders=, val_dataloaders=)
